...
class MakeDeviceImage(qt.QWidget):
    ...
    def selection_changed(self):
        ...
        self.labelfield.setText("{}_{} ".format(
            selected_instrument, selected_parameter))
    ...
    def saveAndClose(self):
        ...
        datafilename = os.path.join(
            self.folder, 'deviceimage_annotations.json')
                ...
                try:
                    ...
                    try:
                        ...
                        if val.get('annotationformatter'):
                            valuestr = val.get(
                                'annotationformatter').format(floatvalue)
