...
class DriveFrequencyAlazarOld(Parameter):
    def __init__(self, name, alazar_ctrl, extr='min'):
        super().__init__(name, unit='Hz')
...
class DriveFrequencyAlazarNew(Parameter):
    def __init__(self, name, alazar_ctrl_ch, extr='min'):
        super().__init__(name, unit='Hz')
